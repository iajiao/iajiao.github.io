...
我的博客使用Jekyll 技术，建立在Github Pages上。GitHub虽然非常稳定，但因为没有后台，更新起来非常麻烦。之前我曾使用过一段时间Obsidian。虽然Obsidian堪称神器，但仅限于电脑端。在安卓手机上，不仅难以操作，而且启动速度也很慢。


最近，我发现Notion用起来特别顺手，突发奇想：能否用Notion作为博客后台，实现与Github的互动呢？


# v1 版本出炉


答案是可以的！在Deepseek的帮助下，经过大约10个小时的努力，准确得说是：看球睡不着的大半个晚上，以及小半个白天，我终于通过编写 github action代码，实现了Notion与Github的互动，简称 V1 版本，主要实现了博客内容从 notion 到 github 的同步。具体代码如下：
...
然而，我的需求并非仅仅只是同步，我还想实现增量同步提高效率，在 notion 中管理文档删除增加便利，提高代码运行效率。经过长达周五晚间和周六全天的尝试，终于成功了，这个版本简称 V2。除了 deepseek 之外，kimi 也提供了巨大的帮助。
